...
export const SearchModal = ({ isOpen, onClose, projects, onSelectProject, onQuickNavigate }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-start justify-center pt-[15vh] bg-zinc-50/40 dark:bg-black/30 backdrop-blur-sm transition-all duration-300" style={{ zIndex: Z_INDEX.MODAL_BACKDROP }} onClick={onClose}>
      <div 
